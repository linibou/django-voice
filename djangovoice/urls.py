...
urlpatterns = patterns(
    ...
    url(r'%s/(?P<type>[-\w]+)/(?P<status>[-\w]+)/$' % feedback_list_regex, view=FeedbackListView.as_view(), name='djangovoice_list_type_status'),
    ...
    url(r'^signin/$', view=login, name='djangovoice_signin',
        kwargs={
